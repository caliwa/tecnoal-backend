...
$(document).ready(function() {
    ...
    function cargarVentasMes() {
        ...
        var url = 'https://rdpd.sagerp.co:59881/gestioncalidad/public/ventas-mes-seguimiento-ajax/' + anios;
  ...
  $(document).ready(function() {
    ...
    function dibujarGrafico() {
        ...
        if (anio !== anioSeleccionado) {
            ...
            // Obtener los datos
            $.ajax({
                url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/ventas-mes-ajax/' + anio,
                success: function(data) {
                    // Destruir instancia del gráfico anterior si existe
                    if (chart !== null) {
                        chart.destroy();
...
function cargarVentasMesTipologia() {
    ...
    var url = 'https://rdpd.sagerp.co:59881/gestioncalidad/public/ventas-mes-tipologia-ajax/' + anio + '/' + tipologia;
...
function cargarVentasMesTipologiaSeguimiento() {
    ...
    var url = 'https://rdpd.sagerp.co:59881/gestioncalidad/public/ventas-mes-tipologia-seguimiento-ajax/' + anio + '/' + tipologiaseguimiento;
...
$(document).ready(function() {
    ...
    function dibujarGrafico() {
        ...
        // Obtener los datos
        $.ajax({
            url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/VentasGeneralesTipologia/' + anio,
            type: 'GET',
            success: function(data) {
...
$(document).ready(function() {
    ...
    function dibujarGrafico() {
        ...
        if (anio !== anioSeleccionado) {
            ...
            // Obtener los datos
            $.ajax({
                url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/CotizacionesGeneralesTipologia/' + anio,
                type: 'GET',
                success: function(data) {
                    // Transformar los datos en un formato que pueda ser utilizado por Chart.js
                    var datos = {};
...
$(document).ready(function() {
    ...
    function dibujarGraficoOrigen() {
        ...
        // Obtener los datos
        $.ajax({
            url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/VentasOrigenes/' + anio,
            type: 'GET',
            success: function(data) {
                // Transformar los datos en un formato que pueda ser utilizado por Chart.js
                var datos = {};
...
function obtenerVentasPorPais(anio) {
    $.ajax({
        url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/Ventas-mes-pais/' + anio,
        method: 'GET',
...
function obtenerVentasPorPaisSeguimiento(anio, mes) {
    $.ajax({
        url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/Ventas-mes-pais-seguimiento/' + anio + '/' + mes,
        method: 'GET',
        success: function(response) {
...
// Obtiene los datos de los costos de calidad para Vortex
...
function obtenerCostosCalidad(anio) {
    $.ajax({
        url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/Costos-nocalidad-vortex/' + anio,
        type: 'GET',
        dataType: 'json',
        success: function(data) {
...
$(document).ready(function() {
    ...
    function cargarIndicador() {
        ...
        $.ajax({
            url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/VentasAsesor/' + anio + '/' + mes,
            type: 'GET',
            success: function(response) {
    ...
    function actualizarGrafico() {
        ...
        var backgroundColors = ['#FF5733', '#36A2EB', '#FFCE56', '#00CC99', '#FF5733', '#6F4E37', '#9B59B6', '#7D6608', '#C0392B', '#27AE60', '#2980B9', '#F39C12'];
            ...
            ventasAsesorChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        borderColor: borderColors, // Color del borde de las barras
...
$(document).ready(function() {
    ...
    function cargarIndicador() {
        ...
        // Hacer la solicitud AJAX
        $.ajax({
            url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/VentasAsesorSeguimiento/' + anio + '/' + mes,
            type: 'GET',
            success: function(response) {
        ...
        if (anio !== anioSeleccionado) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var colors = ['#071703', '#36A2EB', '#FFCE56', '#00CC99', '#FF5733', '#6F4E37', '#9B59B6', '#7D6608', '#C0392B', '#27AE60', '#2980B9', '#F39C12'];
...
$(document).ready(function() {
    ...
    function cargarMetrosCuadradosPorMes() {
        ...
        var url = 'https://rdpd.sagerp.co:59881/gestioncalidad/public/MetrosCuadrados/' + anio;
...
$(document).ready(function() {
    ...
    function cargarPorcentajeExitoVentas(anio) {
        var url = 'https://rdpd.sagerp.co:59881/gestioncalidad/public/Porcentaje-Exito-cotizaciones/' + anio;
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var porcentajeRedondeado = parseFloat((Math.round(data[i].porcentaje * 10) / 10).toFixed(1));
